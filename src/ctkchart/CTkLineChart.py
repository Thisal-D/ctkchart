...
class CTkLineChart:
    ...
    def get_lines_data(self, start: int = None, end: int = None, step: int = None) -> Dict[CTkLine, Tuple[int]]:
        """
    ...
    def get_line_data(self, line: CTkLine, start: int = None, end: int = None, step: int = None) -> Tuple[int | float]:
        """
        Retrieve data points for a specific line within a specified range and step.

        Args:
            line (CTkLine): The line object whose data should be retrieved.
            start (int, optional): The starting index for slicing the data. Defaults to None.
            end (int, optional): The ending index for slicing the data. Defaults to None.
            step (int, optional): The step size for slicing the data. Defaults to None.
    ...
    def get_line_visible_data(self, line: CTkLine) -> Tuple[int | float]:
        ...
        Args:
            line (CTkLine): The line object whose visible data should be retrieved.
